.PHONY: test test-unit test-integration test-bench lint lint-fix security coverage clean help check ci install-tools install-hooks proto
...
security: ## Run security scanner
	@gosec -quiet -exclude-dir=testing -exclude-generated -exclude=G304 ./...
